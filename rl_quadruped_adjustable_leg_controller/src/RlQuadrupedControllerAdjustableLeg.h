...
#include "rl_quadruped_adjustable_leg_controller/FSM/StatePassiveAdjustableLeg.h"
...
namespace rl_quadruped_adjustable_leg_controller
{
    struct FSMStateList
    {
        ...
        std::shared_ptr<StateRL> rlPolicy2;
    };
    ...
    private:
        ...
        std::vector<double> stand_pos_adjustable_leg_ = {
            0.0, 0.67, -1.3, 0.12,
            0.0, 0.67, -1.3, 0.12,
            0.0, 0.67, -1.3, 0.12,
            0.0, 0.67, -1.3, 0.12
        ...
        double stand_kp_ = 200.0;
        double stand_kd_ = 3.5;
        double stand_kp_prismatic_joint = 4000.0;
