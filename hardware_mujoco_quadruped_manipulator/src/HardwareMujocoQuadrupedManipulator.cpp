...
#include "hardware_mujoco_quadruped_manipulator/HardwareMujocoQuadrupedManipulator.h"
...
rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn HardwareMujocoQuadrupedManipulator::on_init(
...
std::vector<hardware_interface::StateInterface> HardwareMujocoQuadrupedManipulator::export_state_interfaces()
{
...
std::vector<hardware_interface::CommandInterface> HardwareMujocoQuadrupedManipulator::export_command_interfaces()
{
...
return_type HardwareMujocoQuadrupedManipulator::read(const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
...
return_type HardwareMujocoQuadrupedManipulator::write(const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
...
void HardwareMujocoQuadrupedManipulator::imu_callback(const sensor_msgs::msg::Imu imu_state)
{
...
PLUGINLIB_EXPORT_CLASS(HardwareMujocoQuadrupedManipulator, hardware_interface::SystemInterface)
