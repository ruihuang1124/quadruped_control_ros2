...
namespace ArcLab
{
    ...
    class QMMujocoMsgHandler : public rclcpp::Node
    {
    public:
        ...
        QMMujocoMsgHandler(mj::Simulate *sim);
        ~QMMujocoMsgHandler();
    ...
    private:
        ...
        rclcpp::Publisher<sensor_msgs::msg::JointState>::SharedPtr quadruped_joint_state_publisher_;
        rclcpp::Publisher<sensor_msgs::msg::JointState>::SharedPtr manipulator_joint_state_publisher_;
        ...
        const int num_quadruped_joints_ = 12;
    };
} // ArcLab
