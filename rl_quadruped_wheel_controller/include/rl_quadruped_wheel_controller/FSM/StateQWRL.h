...
struct ModelParams
{
    ...
    torch::Tensor default_dof_pos_leg;
...
class StateQWRL final : public FSMState
{
public:
    explicit StateQWRL(CtrlInterfaces& ctrl_interfaces,
...
private:
    ...
    */
    ...
    std::string robot_pkg_ = "sirius_wheel_description";
