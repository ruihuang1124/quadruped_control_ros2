...
#include "model_based_controller/robot/QuadrupedRobot.h"

namespace model_based_controller
{
    using config_type = controller_interface::interface_configuration_type;

    controller_interface::InterfaceConfiguration ModelBasedController::command_interface_configuration() const
    {
    ...
    controller_interface::InterfaceConfiguration ModelBasedController::state_interface_configuration() const
    {
        controller_interface::InterfaceConfiguration conf = {config_type::INDIVIDUAL, {}};
    ...
    controller_interface::return_type ModelBasedController::
    ...
    controller_interface::CallbackReturn ModelBasedController::on_init()
    {
        try
        {
            ...
            feet_names_ =
                auto_declare<std::vector<std::string>>("feet", feet_names_);
    ...
    controller_interface::CallbackReturn ModelBasedController::on_configure(
        const rclcpp_lifecycle::State& /*previous_state*/)
    {
        ...
        robot_description_subscription_ = get_node()->create_subscription<std_msgs::msg::String>(
            ...
            {
                std::cerr << "\n### Start subscribers robot model!!!!!!!!!"<<std::endl;
    ...
    ModelBasedController::on_activate(const rclcpp_lifecycle::State& /*previous_state*/)
    {
    ...
    controller_interface::CallbackReturn ModelBasedController::on_deactivate(
        const rclcpp_lifecycle::State& /*previous_state*/)
    {
        release_interfaces();
        return CallbackReturn::SUCCESS;
    ...
    controller_interface::CallbackReturn
    ModelBasedController::on_cleanup(const rclcpp_lifecycle::State& /*previous_state*/)
    {
        return CallbackReturn::SUCCESS;
    }

    controller_interface::CallbackReturn
    ModelBasedController::on_error(const rclcpp_lifecycle::State& /*previous_state*/)
    {
        return CallbackReturn::SUCCESS;
    }

    controller_interface::CallbackReturn
    ModelBasedController::on_shutdown(const rclcpp_lifecycle::State& /*previous_state*/)
    {
        return CallbackReturn::SUCCESS;
    }

    std::shared_ptr<FSMState> ModelBasedController::getNextState(const FSMStateName stateName) const
    {
        switch (stateName)
        {
...
PLUGINLIB_EXPORT_CLASS(model_based_controller::ModelBasedController, controller_interface::ControllerInterface);
