...
#include <piper_example_controllers/joint_position_example_controller.hpp>
#include <piper_example_controllers/robot_utils.hpp>
...
// NOLINTNEXTLINE
PLUGINLIB_EXPORT_CLASS(piper_example_controllers::JointPositionExampleController,
