...
class StateIKRL final : public FSMState
{
public:
    explicit StateIKRL(CtrlInterfaces& ctrl_interfaces,
...
private:
    ...
    */
    ...
    std::string robot_pkg_ = "quadruped_manipulator_description";
