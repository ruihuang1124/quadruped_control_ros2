...
namespace rl_quadruped_manipulation_controller
{
    ...
    controller_interface::InterfaceConfiguration LeggedManipulationRLController::command_interface_configuration() const
    {
    ...
    controller_interface::CallbackReturn LeggedManipulationRLController::on_init()
    {
        try
        {
            ...
            ctrl_interfaces_.pose_cmd_inputs_.pos_z = 0.25;
    ...
    controller_interface::CallbackReturn LeggedManipulationRLController::on_error(const rclcpp_lifecycle::State& previous_state)
    {
...
PLUGINLIB_EXPORT_CLASS(rl_quadruped_manipulation_controller::LeggedManipulationRLController, controller_interface::ControllerInterface);
