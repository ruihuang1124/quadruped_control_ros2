...
def launch_setup(context, *args, **kwargs):
    ...
    # 注意：键盘控制节点不在此 launch 文件中启动
    # 因为键盘节点需要在能接收键盘输入的独立交互终端中运行
    # 请通过 launch_all.sh 或手动执行以下命令启动键盘控制：
    #   source /opt/ros/humble/setup.bash
    #   source /home/mallow/ocs2_2/install/setup.bash
...
def generate_launch_description():
    robot_pkg = DeclareLaunchArgument(
        "robot_pkg",
        default_value="arcdog_adjustable_leg_description",  # 16-DOF 弹簧腿机器狗
