...
rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn HardwareArcdog::on_init(
...
std::vector<hardware_interface::StateInterface> HardwareArcdog::export_state_interfaces()
{
...
std::vector<hardware_interface::CommandInterface> HardwareArcdog::export_command_interfaces()
{
...
PLUGINLIB_EXPORT_CLASS(HardwareArcdog, hardware_interface::SystemInterface)
