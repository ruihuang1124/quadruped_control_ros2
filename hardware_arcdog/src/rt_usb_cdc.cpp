...
void leg_command_to_can_command(LEG_COMMAND_T *leg_cmd, CAN_COMMAND *can_cmd) {
    ...
    can_cmd[3].p_des = float_to_uint(leg_cmd->q_des_prismatic, P_MIN_HT, P_MAX_HT,16);
    can_cmd[3].v_des = float_to_uint(leg_cmd->qd_des_prismatic, V_MIN_HT, V_MAX_HT,12);
    can_cmd[3].kp = float_to_uint(leg_cmd->kp_prismatic, KP_MIN_HT, KP_MAX_HT, 12);
    can_cmd[3].kd = float_to_uint(leg_cmd->kd_prismatic, KD_MIN_HT, KD_MAX_HT, 12);
    can_cmd[3].t_ff = float_to_uint(leg_cmd->tau_prismatic_ff, T_MIN_HT_03, T_MAX_HT_03, 12);
}
...
void can_data_to_leg_data(CAN_DATA *can_data, LEG_DATA_T *leg_data) {
    ...
    leg_data->q_prismatic = uint_to_float(can_data[3].POS, P_MIN_HT, P_MAX_HT,16);
    leg_data->qd_prismatic = uint_to_float(can_data[3].VEL, V_MIN_HT, V_MAX_HT,12);
    leg_data->tau_prismatic = uint_to_float(can_data[3].T, T_MIN_HT_03, T_MAX_HT_03,12);
}
