...
```bash
cd ~/ros2_ws
colcon build --packages-up-to go2_arm_description --symlink-install
```
...
ros2 launch go2_arm_description visualize.launch.py
```
...
* RL Quadruped Controller
  ```bash
  source ~/ros2_ws/install/setup.bash
  ros2 launch go2_arm_description gazebo_rl_control.launch.py
  ```
...
Open "go2_arm_description.urdf" in "./go2_arm_description/urdf",
