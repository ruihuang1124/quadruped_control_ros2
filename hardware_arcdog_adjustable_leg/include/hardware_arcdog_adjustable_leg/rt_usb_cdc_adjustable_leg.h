...
#define ARCDOG_K_PRISMATIC_OFFSET_POS_0   0.03f
#define ARCDOG_K_PRISMATIC_OFFSET_POS_1   0.03f
#define ARCDOG_K_PRISMATIC_OFFSET_POS_2   0.03f
#define ARCDOG_K_PRISMATIC_OFFSET_POS_3   0.03f
